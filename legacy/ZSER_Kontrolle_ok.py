...
try:  # try to get a previous parameters file
    with open(workpath + '/LastParams.pickle', 'rb') as opener:
        expInfo = pickle.load(opener)
except Exception as e:  # if not there then use a default set
    print(e)
    expInfo = {'1. participant': '000', '2. x-coordinate PRL': 0., '3. y-coordinate PRL': 0.,
               '4. x-coordinate oppPRL': 0., '5. y-coordinate oppPRL': 0., '6. distance from screen': 50}
#
#
#
...
##
# number of trials
trialn = 2  # minimum number of trials per staircase (not including control trials)
##
